...
export const CLUBS: ClubData[] = [
  ...
  },
  {
    ...
    location: 'Lima',
    description:
      'Club recreativo con piscinas y toboganes, perfecto para paseos divertidos y eventos donde la diversión acuática es el protagonista. Ideal para colegios y empresas que buscan una experiencia lúdica única.',
    features: ['Piscinas', 'Toboganes', 'Áreas recreativas', 'Vestuarios'],
